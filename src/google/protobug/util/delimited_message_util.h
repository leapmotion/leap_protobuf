...
#ifndef GOOGLE_PROTOBUG_UTIL_DELIMITED_MESSAGE_UTIL_H__
#define GOOGLE_PROTOBUG_UTIL_DELIMITED_MESSAGE_UTIL_H__
...
#endif  // GOOGLE_PROTOBUG_UTIL_DELIMITED_MESSAGE_UTIL_H__
