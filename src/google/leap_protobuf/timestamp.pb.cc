...
// source: google/leap_protobuf/timestamp.proto
...
class TimestampDefaultTypeInternal {
 public:
  ::google::leap_protobuf::internal::ExplicitlyConstructed<Timestamp>
      _instance;
...
static void InitDefaultsTimestamp() {
  ...
  {
    void* ptr = &::google::leap_protobuf::_Timestamp_default_instance_;
    new (ptr) ::google::leap_protobuf::Timestamp();
    ::google::leap_protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::google::leap_protobuf::Timestamp::InitAsDefaultInstance();
}

LIBPROTOBUF_EXPORT ::google::leap_protobuf::internal::SCCInfo<0> scc_info_Timestamp =
    {{ATOMIC_VAR_INIT(::google::leap_protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsTimestamp}, {}};

void InitDefaults() {
  ::google::leap_protobuf::internal::InitSCC(&scc_info_Timestamp.base);
}
...
const ::google::leap_protobuf::uint32 TableStruct::offsets[] GOOGLE_LEAP_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_LEAP_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::google::leap_protobuf::Timestamp, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_LEAP_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::google::leap_protobuf::Timestamp, seconds_),
  GOOGLE_LEAP_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::google::leap_protobuf::Timestamp, nanos_),
};
static const ::google::leap_protobuf::internal::MigrationSchema schemas[] GOOGLE_LEAP_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::google::leap_protobuf::Timestamp)},
};

static ::google::leap_protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::leap_protobuf::Message*>(&::google::leap_protobuf::_Timestamp_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/leap_protobuf/timestamp.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_LEAP_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\037google/leap_protobuf/timestamp.proto\022\017googl"
  ...
  ::google::leap_protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "google/leap_protobuf/timestamp.proto", &protobuf_RegisterTypes);
}
...
Timestamp::Timestamp(::google::leap_protobuf::Arena* arena)
  : ::google::leap_protobuf::Message(),
  _internal_metadata_(arena) {
  ::google::leap_protobuf::internal::InitSCC(&protobuf_google_2fprotobuf_2ftimestamp_2eproto::scc_info_Timestamp.base);
  SharedCtor();
...
void Timestamp::RegisterArenaDtor(::google::leap_protobuf::Arena* arena) {
}
void Timestamp::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ::google::leap_protobuf::Descriptor* Timestamp::descriptor() {
...
::google::leap_protobuf::uint8* Timestamp::InternalSerializeWithCachedSizesToArray(
...
void Timestamp::MergeFrom(const ::google::leap_protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:google.protobuf.Timestamp)
  GOOGLE_DCHECK_NE(&from, this);
  const Timestamp* source =
      ::google::leap_protobuf::internal::DynamicCastToGenerated<const Timestamp>(
          &from);
  if (source == NULL) {
...
void Timestamp::CopyFrom(const ::google::leap_protobuf::Message& from) {
...
::google::leap_protobuf::Metadata Timestamp::GetMetadata() const {
  protobuf_google_2fprotobuf_2ftimestamp_2eproto::protobuf_AssignDescriptorsOnce();
...
namespace google {
namespace leap_protobuf {
template<> GOOGLE_LEAP_PROTOBUF_ATTRIBUTE_NOINLINE ::google::leap_protobuf::Timestamp* Arena::CreateMaybeMessage< ::google::leap_protobuf::Timestamp >(Arena* arena) {
  return Arena::CreateMessageInternal< ::google::leap_protobuf::Timestamp >(arena);
}
}  // namespace leap_protobuf
}  // namespace google
