...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fprotobuf_2fstruct_2eproto ::google::leap_protobuf::internal::SCCInfo<0> scc_info_ListValue;
}  // namespace protobuf_google_2fprotobuf_2fstruct_2eproto
namespace google {
namespace leap_protobuf {
class Struct_FieldsEntry_DoNotUseDefaultTypeInternal {
 public:
  ::google::leap_protobuf::internal::ExplicitlyConstructed<Struct_FieldsEntry_DoNotUse>
      _instance;
} _Struct_FieldsEntry_DoNotUse_default_instance_;
class StructDefaultTypeInternal {
 public:
  ::google::leap_protobuf::internal::ExplicitlyConstructed<Struct>
      _instance;
} _Struct_default_instance_;
class ValueDefaultTypeInternal {
 public:
  ::google::leap_protobuf::internal::ExplicitlyConstructed<Value>
      _instance;
  int null_value_;
  double number_value_;
  ::google::leap_protobuf::internal::ArenaStringPtr string_value_;
  bool bool_value_;
  const ::google::leap_protobuf::Struct* struct_value_;
  const ::google::leap_protobuf::ListValue* list_value_;
} _Value_default_instance_;
class ListValueDefaultTypeInternal {
 public:
  ::google::leap_protobuf::internal::ExplicitlyConstructed<ListValue>
      _instance;
...
static void InitDefaultsListValue() {
...

  {
    ...
    new (ptr) ::google::leap_protobuf::Struct_FieldsEntry_DoNotUse();
  }
  {
    void* ptr = &::google::leap_protobuf::_Struct_default_instance_;
    new (ptr) ::google::leap_protobuf::Struct();
    ::google::leap_protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  {
    void* ptr = &::google::leap_protobuf::_Value_default_instance_;
    new (ptr) ::google::leap_protobuf::Value();
    ::google::leap_protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  {
    void* ptr = &::google::leap_protobuf::_ListValue_default_instance_;
    new (ptr) ::google::leap_protobuf::ListValue();
    ::google::leap_protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::google::leap_protobuf::Struct_FieldsEntry_DoNotUse::InitAsDefaultInstance();
  ::google::leap_protobuf::Struct::InitAsDefaultInstance();
  ::google::leap_protobuf::Value::InitAsDefaultInstance();
  ::google::leap_protobuf::ListValue::InitAsDefaultInstance();
}

LIBPROTOBUF_EXPORT ::google::leap_protobuf::internal::SCCInfo<0> scc_info_ListValue =
    {{ATOMIC_VAR_INIT(::google::leap_protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsListValue}, {}};

void InitDefaults() {
  ::google::leap_protobuf::internal::InitSCC(&scc_info_ListValue.base);
}
...
const ::google::leap_protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(::google::leap_protobuf::ValueDefaultTypeInternal, string_value_),
...
static const ::google::leap_protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 27, -1, sizeof(::google::leap_protobuf::ListValue)},
};

static ::google::leap_protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::leap_protobuf::Message*>(&::google::leap_protobuf::_Struct_FieldsEntry_DoNotUse_default_instance_),
  reinterpret_cast<const ::google::leap_protobuf::Message*>(&::google::leap_protobuf::_Struct_default_instance_),
  reinterpret_cast<const ::google::leap_protobuf::Message*>(&::google::leap_protobuf::_Value_default_instance_),
  reinterpret_cast<const ::google::leap_protobuf::Message*>(&::google::leap_protobuf::_ListValue_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/leap_protobuf/struct.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::leap_protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "google/leap_protobuf/struct.proto", &protobuf_RegisterTypes);
}
...
namespace google {
namespace leap_protobuf {
const ::google::leap_protobuf::EnumDescriptor* NullValue_descriptor() {
...
Struct_FieldsEntry_DoNotUse::Struct_FieldsEntry_DoNotUse(::google::leap_protobuf::Arena* arena) : SuperType(arena) {}
void Struct_FieldsEntry_DoNotUse::MergeFrom(const Struct_FieldsEntry_DoNotUse& other) {
  MergeFromInternal(other);
}
::google::leap_protobuf::Metadata Struct_FieldsEntry_DoNotUse::GetMetadata() const {
  ::protobuf_google_2fprotobuf_2fstruct_2eproto::protobuf_AssignDescriptorsOnce();
...
Struct::Struct(::google::leap_protobuf::Arena* arena)
  : ::google::leap_protobuf::Message(),
  _internal_metadata_(arena),
  fields_(arena) {
  ::google::leap_protobuf::internal::InitSCC(&protobuf_google_2fprotobuf_2fstruct_2eproto::scc_info_ListValue.base);
  SharedCtor();
...
void Struct::RegisterArenaDtor(::google::leap_protobuf::Arena* arena) {
}
void Struct::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ::google::leap_protobuf::Descriptor* Struct::descriptor() {
  ::protobuf_google_2fprotobuf_2fstruct_2eproto::protobuf_AssignDescriptorsOnce();
    ...
    switch (::google::leap_protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::leap_protobuf::uint8>(tag) ==
          ...
          Struct_FieldsEntry_DoNotUse::Parser< ::google::leap_protobuf::internal::MapField<
              ...
              0 >,
            ::google::leap_protobuf::Map< ::std::string, ::google::leap_protobuf::Value > > parser(&fields_);
...
void Struct::SerializeWithCachedSizes(
  ...
  if (!this->fields().empty()) {
    typedef ::google::leap_protobuf::Map< ::std::string, ::google::leap_protobuf::Value >::const_pointer
        ConstPtr;
    typedef ConstPtr SortItem;
    typedef ::google::leap_protobuf::internal::CompareByDerefFirst<SortItem> Less;
    struct Utf8Check {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      typedef ::google::leap_protobuf::Map< ::std::string, ::google::leap_protobuf::Value >::size_type size_type;
      size_type n = 0;
      for (::google::leap_protobuf::Map< ::std::string, ::google::leap_protobuf::Value >::const_iterator
...
::google::leap_protobuf::uint8* Struct::InternalSerializeWithCachedSizesToArray(
...
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.Struct)
  ...
  // map<string, .google.protobuf.Value> fields = 1;
  total_size += 1 *
      ::google::leap_protobuf::internal::FromIntSize(this->fields_size());
  {
    ::std::unique_ptr<Struct_FieldsEntry_DoNotUse> entry;
    for (::google::leap_protobuf::Map< ::std::string, ::google::leap_protobuf::Value >::const_iterator
        it = this->fields().begin();
...
void Struct::MergeFrom(const ::google::leap_protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:google.protobuf.Struct)
  GOOGLE_DCHECK_NE(&from, this);
  const Struct* source =
      ::google::leap_protobuf::internal::DynamicCastToGenerated<const Struct>(
          &from);
  if (source == NULL) {
...
void Struct::CopyFrom(const ::google::leap_protobuf::Message& from) {
...
::google::leap_protobuf::Metadata Struct::GetMetadata() const {
  protobuf_google_2fprotobuf_2fstruct_2eproto::protobuf_AssignDescriptorsOnce();
...
void Value::InitAsDefaultInstance() {
  ::google::leap_protobuf::_Value_default_instance_.null_value_ = 0;
  ::google::leap_protobuf::_Value_default_instance_.number_value_ = 0;
  ::google::leap_protobuf::_Value_default_instance_.string_value_.UnsafeSetDefault(
      &::google::leap_protobuf::internal::GetEmptyStringAlreadyInited());
  ::google::leap_protobuf::_Value_default_instance_.bool_value_ = false;
  ::google::leap_protobuf::_Value_default_instance_.struct_value_ = const_cast< ::google::leap_protobuf::Struct*>(
      ::google::leap_protobuf::Struct::internal_default_instance());
  ::google::leap_protobuf::_Value_default_instance_.list_value_ = const_cast< ::google::leap_protobuf::ListValue*>(
      ::google::leap_protobuf::ListValue::internal_default_instance());
}
void Value::set_allocated_struct_value(::google::leap_protobuf::Struct* struct_value) {
  ::google::leap_protobuf::Arena* message_arena = GetArenaNoVirtual();
  clear_kind();
  if (struct_value) {
    ::google::leap_protobuf::Arena* submessage_arena =
      ::google::leap_protobuf::Arena::GetArena(struct_value);
    if (message_arena != submessage_arena) {
      struct_value = ::google::leap_protobuf::internal::GetOwnedMessage(
...
void Value::set_allocated_list_value(::google::leap_protobuf::ListValue* list_value) {
  ::google::leap_protobuf::Arena* message_arena = GetArenaNoVirtual();
  clear_kind();
  if (list_value) {
    ::google::leap_protobuf::Arena* submessage_arena =
      ::google::leap_protobuf::Arena::GetArena(list_value);
    if (message_arena != submessage_arena) {
      list_value = ::google::leap_protobuf::internal::GetOwnedMessage(
...
Value::Value(::google::leap_protobuf::Arena* arena)
  : ::google::leap_protobuf::Message(),
  _internal_metadata_(arena) {
  ::google::leap_protobuf::internal::InitSCC(&protobuf_google_2fprotobuf_2fstruct_2eproto::scc_info_ListValue.base);
  SharedCtor();
...
Value::Value(const Value& from)
  ...
  switch (from.kind_case()) {
    ...
    case kStructValue: {
      mutable_struct_value()->::google::leap_protobuf::Struct::MergeFrom(from.struct_value());
      break;
    }
    case kListValue: {
      mutable_list_value()->::google::leap_protobuf::ListValue::MergeFrom(from.list_value());
      break;
    }
    case KIND_NOT_SET: {
      break;
...
void Value::RegisterArenaDtor(::google::leap_protobuf::Arena* arena) {
}
void Value::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ::google::leap_protobuf::Descriptor* Value::descriptor() {
  ::protobuf_google_2fprotobuf_2fstruct_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_google_2fprotobuf_2fstruct_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::leap_protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::leap_protobuf::uint8>(tag) ==
          ...
          DO_((::google::leap_protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_null_value(static_cast< ::google::leap_protobuf::NullValue >(value));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 2: {
        if (static_cast< ::google::leap_protobuf::uint8>(tag) ==
            static_cast< ::google::leap_protobuf::uint8>(17u /* 17 & 0xFF */)) {
          clear_kind();
          DO_((::google::leap_protobuf::internal::WireFormatLite::ReadPrimitive<
...
void Value::SerializeWithCachedSizes(
  ...
  // double number_value = 2;
  if (has_number_value()) {
    ::google::leap_protobuf::internal::WireFormatLite::WriteDouble(2, this->number_value(), output);
  }
  ...
  // bool bool_value = 4;
  if (has_bool_value()) {
    ::google::leap_protobuf::internal::WireFormatLite::WriteBool(4, this->bool_value(), output);
  }
...
::google::leap_protobuf::uint8* Value::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::leap_protobuf::uint8* target) const {
  (void)deterministic; // Unused
  ...
  // double number_value = 2;
  if (has_number_value()) {
    target = ::google::leap_protobuf::internal::WireFormatLite::WriteDoubleToArray(2, this->number_value(), target);
  }
  ...
  // bool bool_value = 4;
  if (has_bool_value()) {
    target = ::google::leap_protobuf::internal::WireFormatLite::WriteBoolToArray(4, this->bool_value(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.Value)
  ...
  switch (kind_case()) {
    ...
    case kNullValue: {
      total_size += 1 +
        ::google::leap_protobuf::internal::WireFormatLite::EnumSize(this->null_value());
      break;
    }
    // double number_value = 2;
    case kNumberValue: {
...
void Value::MergeFrom(const ::google::leap_protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:google.protobuf.Value)
  GOOGLE_DCHECK_NE(&from, this);
  const Value* source =
      ::google::leap_protobuf::internal::DynamicCastToGenerated<const Value>(
          &from);
  if (source == NULL) {
...
void Value::CopyFrom(const ::google::leap_protobuf::Message& from) {
...
::google::leap_protobuf::Metadata Value::GetMetadata() const {
  protobuf_google_2fprotobuf_2fstruct_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_google_2fprotobuf_2fstruct_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
ListValue::ListValue(::google::leap_protobuf::Arena* arena)
  : ::google::leap_protobuf::Message(),
  _internal_metadata_(arena),
  values_(arena) {
  ::google::leap_protobuf::internal::InitSCC(&protobuf_google_2fprotobuf_2fstruct_2eproto::scc_info_ListValue.base);
...
void ListValue::RegisterArenaDtor(::google::leap_protobuf::Arena* arena) {
}
void ListValue::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ::google::leap_protobuf::Descriptor* ListValue::descriptor() {
  ::protobuf_google_2fprotobuf_2fstruct_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_google_2fprotobuf_2fstruct_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::leap_protobuf::uint8* ListValue::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::leap_protobuf::uint8* target) const {
  (void)deterministic; // Unused
...
void ListValue::MergeFrom(const ::google::leap_protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:google.protobuf.ListValue)
  GOOGLE_DCHECK_NE(&from, this);
  const ListValue* source =
      ::google::leap_protobuf::internal::DynamicCastToGenerated<const ListValue>(
          &from);
  if (source == NULL) {
...
void ListValue::CopyFrom(const ::google::leap_protobuf::Message& from) {
...
::google::leap_protobuf::Metadata ListValue::GetMetadata() const {
  protobuf_google_2fprotobuf_2fstruct_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_google_2fprotobuf_2fstruct_2eproto::file_level_metadata[kIndexInFileMessages];
}
